!function(){
	var bP={};	
	//b = width of bars
	//bb = length of space between main bars
	//height = height of graph but it cuts off
	//buffMargin = Margin of buffer between unrelated main bars
	var b=30, bb=350, height=700, buffMargin=1, minHeight=14;
	var c1=[-160, 35], c2=[-30, 210], c3=[-1, 245]; //Column positions of labels.
	var colors =["#3366CC", "#DC3912",  "#FF9900", "#109618", "#990099", "#0099C6", "#4477CC", 
		"#ED6912",  "#FF9920" ,"#30D618", "#11AA99", "#3399C6", "#3388CC", "#DC5912",  "#FFBB00", "#10BA18", "#992299", 
		"#00BBC6", "#4499CC", "#ED9912",  "#FFBB20" ,"#30F818", "#11CC99", "#33BBC6"];
	...
	function drawHeader(header, id){
		d3.select("#"+id).append("g").attr("class","header").append("text").text(header[2])
			.style("font-size","20").attr("x",208).attr("y",-20).style("text-anchor","middle")
		...
		[0,1].forEach(function(d){
			...
			h.append("text").text("Interaction Count").attr("x", (c2[d]-10))
				.attr("y", -5).style("fill","grey");
